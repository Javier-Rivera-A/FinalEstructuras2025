...
public class NotificationServiceImp implements NotificationService {
    ...
    public NotificationServiceImp(NotificationRepository repository) {
        this.notificationRepository = new NotificationRepository("src/main/resources/Persistence/accounts.txt");
    }
